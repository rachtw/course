...
int main() {
  ...
  cout << "SFO " << (*locators['S'-'A']).getKey() << endl;
  cout << "LAX " << (*locators['L'-'A']).getKey() << endl;
  cout << "ORD " << (*locators['O'-'A']).getKey() << endl;
  cout << "DFW " << (*locators['D'-'A']).getKey() << endl;
  cout << "JFK " << (*locators['J'-'A']).getKey() << endl;
  cout << "BOS " << (*locators['B'-'A']).getKey() << endl;
  cout << "PVD " << (*locators['P'-'A']).getKey() << endl;
  cout << "BWI " << (*locators['W'-'A']).getKey() << endl;
  cout << "MIA " << (*locators['M'-'A']).getKey() << endl;
