...
plot(power2$Time2,power2$Global_active_power,type="l",xlab="",ylab="Global Active Power",cex.lab=0.7,cex.axis=0.7)

plot(power2$Time2,power2$Voltage,type="l",xlab="",ylab="Voltage",cex.lab=0.7,cex.axis=0.7)

plot(power2$Time2,power2$Sub_metering_1,type="l",xlab="",ylab="Energy sub metering",cex.lab=0.7,cex.axis=0.7)
...
plot(power2$Time2,power2$Global_reactive_power,type="l",xlab="",ylab="Global Reactive Power",cex.lab=0.7,cex.axis=0.7)
