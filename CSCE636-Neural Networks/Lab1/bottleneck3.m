...
%write weight file
sd_id_z = hdfsd('start','Wz3.hdf','DFACC_CREATE');
sd_id_o = hdfsd('start','Wo3.hdf','DFACC_CREATE');
sd_id_t = hdfsd('start','Et3.hdf','DFACC_CREATE');
sd_id_v = hdfsd('start','Ev3.hdf','DFACC_CREATE');
