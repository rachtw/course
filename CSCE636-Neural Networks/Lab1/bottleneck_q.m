...
%write weight file
sd_id_z = hdfsd('start','Wz.hdf','DFACC_CREATE');
sd_id_o = hdfsd('start','Wo.hdf','DFACC_CREATE');
sd_id_t = hdfsd('start','Et.hdf','DFACC_CREATE');
sd_id_v = hdfsd('start','Ev.hdf','DFACC_CREATE');
