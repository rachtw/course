...
public class Disk implements Serializable {
    ...
    //One block holds 16384 bytes 
    //  (although a block only holds 8 fields in here)
    //Thus, a relation of 1000 tuples/blocks occupy as much as 15M
    //If memory has 1/3 of the relation size, then the memory 
    //  has only 5M space
    //However, we want to simulate a 600M relation and a 200M memory
    //So we increase the transfer time of a block by 40 folds
    private final static double avg_seek_time=6.46;
    private final static double avg_rotation_latency=4.17;
    private final static double avg_transfer_time_per_block=0.20 * 40;
